...
<head>
    ...
    <title>Vidriex Inventario</title>
        ...
        <ul class="navbar-nav bg-gradient-primary sidebar sidebar-dark accordion <?php echo ($mini) ? 'toggled' : ''; ?>" id="accordionSidebar">
            ...
            <a class="sidebar-brand d-flex align-items-center justify-content-center" href="plantilla.php">
                <div class="sidebar-brand-icon rotate-n-15">
                    <img src="assets/img/logo.jpg" alt="LOGO-JPG" width="45">
                </div>
                <div class="sidebar-brand-text mx-3">Vidriex <sup>Inventario</sup></div>
            </a>
                    ...
                    <ul class="navbar-nav ml-auto">
                        ...
                        <li class="nav-item dropdown no-arrow">
                            <a class="nav-link dropdown-toggle" href="#" id="userDropdown" role="button" data-toggle="dropdown" aria-haspopup="true" aria-expanded="false">
                                ...
                                <img class="img-profile rounded-circle" src="<?php echo RUTA .  'assets/img/avatar.jpg'; ?>">
                            </a>
